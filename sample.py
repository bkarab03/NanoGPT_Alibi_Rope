...
models_to_evaluate = ['gpt2-medium', 'gpt2']
...
# -----------------------------------------------------------------------------
wandb.init(project="model_evaluation")
    ...
    with torch.no_grad():
        with ctx:
            for k in range(num_samples):
                ...
                # Modified the log to also include the model name
                wandb.log({f"{model_name}_generation_time": generation_time})
